    ...
    <body>
        ...
        <div class="locked">
            <div class="lockedpanel">
                <div class="loginuser">
                    <img src="${pageContext.request.contextPath}\resources\images\photos\profile.png" class="img-circle img-online" alt="">
                </div>
                <div class="logged">
                    <h4>Elen Adarna</h4>
        ...
        <script src="${pageContext.request.contextPath}\resources\js\flot\plugins\curvedLines.js"></script>
