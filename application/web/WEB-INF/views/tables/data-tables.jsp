...
<html lang="en">
    <head>
        ...
        <link href="${pageContext.request.contextPath}\resources\css\style.datatables.css" rel="stylesheet">
        <link href="//cdn.datatables.net/responsive/1.0.1/${pageContext.request.contextPath}/resources/css/dataTables.responsive.css" rel="stylesheet">
    ...
    <jsp:include page="/header.do" flush="true"/>
        ...
        <script src="//cdn.datatables.net/responsive/1.0.1/${pageContext.request.contextPath}/resources/js/dataTables.responsive.js"></script>
