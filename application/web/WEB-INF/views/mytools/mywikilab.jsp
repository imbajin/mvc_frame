                        ...
                        <div class="row">
                            <div class="col-sm-4 col-md-3">
                                <div class="text-center">
                                    <img src="${pageContext.request.contextPath}\resources\images\photos\profile-big.jpg" class="img-circle img-offline img-responsive img-profile" alt="">
                                ...
                                <div class="tab-content nopadding noborder">
                                        ...
                                        <div class="activity-list">  
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}\resources\images\photos\user1.png" alt="">
                                                </a>
                                                <div class="media-body">
                                                    <strong>刘尚</strong> 开始了 <strong>C++程序设计——Level 1</strong>. <br>
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}\resources\images\photos\profile.png" alt="">
                                                </a>
                                                <div class="media-body">
                                                    <strong>董强</strong> Java程序设计——数据结构 <Strong>完成</Strong><br>
                                                    <small class="text-muted">Today at 3:18pm</small>
                                                  
                                                    <div class="media blog-media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object thumbnail" src="${pageContext.request.contextPath}\resources\images\photos\media5.png" alt="">
                                                        </a>
                                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object" src="${pageContext.request.contextPath}\resources\images\photos\user2.png" alt="">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <ul class="uploadphoto-list">
                                                        <li><a href="${pageContext.request.contextPath}\resources\images\photos\media1.jpg" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media1.jpg" class="thumbnail img-responsive" alt=""></a></li>
                                                        <li><a href="${pageContext.request.contextPath}\resources\images\photos\media2.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media2.png" class="thumbnail img-responsive" alt=""></a></li>
                                                        <li><a href="${pageContext.request.contextPath}\resources\images\photos\media3.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media3.png" class="thumbnail img-responsive" alt=""></a></li>
                                                    </ul>
                                                </div>
                                            </div><!-- media -->
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}\resources\images\photos\user4.png" alt="">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object thumbnail" src="${pageContext.request.contextPath}\resources\images\photos\media4.png" alt="">
                                                        </a>
                                                        <div class="media-body">
                                                            <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Read more</a></p>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="mb20"></div>
                                                    <a href="${pageContext.request.contextPath}\resources\images\photos\media6.png" data-rel="prettyPhoto" class="img-single"><img src="${pageContext.request.contextPath}\resources\images\photos\media6.png" class="thumbnail img-responsive" alt=""></a>
                                                </div>
                                            </div><!-- media -->
                                  
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}\resources\images\photos\user5.png" alt="">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object thumbnail" src="${pageContext.request.contextPath}\resources\images\photos\media7.png" alt="">
                                                        </a>
                                                        <div class="media-body">
                                                            <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Read more</a></p>
                                    ...
                                    <div class="tab-pane" id="followers">
                                        ...
                                        <div class="follower-list">
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="holder.${pageContext.request.contextPath}\resources\js\100x100.htm" alt="">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <div class="tab-pane" id="following">
                                        ...
                                        <div class="activity-list">
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}\resources\images\photos\user2.png" alt="">
                                                </a>
                                            <div class="media-body">
                                                ...
                                                <ul class="uploadphoto-list">
                                                    <li><a href="${pageContext.request.contextPath}\resources\images\photos\media5.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media5.png" class="thumbnail img-responsive" alt=""></a></li>
                                                    <li><a href="${pageContext.request.contextPath}\resources\images\photos\media4.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media4.png" class="thumbnail img-responsive" alt=""></a></li>
                                                </ul>
                                            </div>
                                        </div><!-- media -->
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <ul class="uploadphoto-list">
                                                    <li><a href="${pageContext.request.contextPath}\resources\images\photos\media6.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media6.png" class="thumbnail img-responsive" alt=""></a></li>
                                                    <li><a href="${pageContext.request.contextPath}\resources\images\photos\media7.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media7.png" class="thumbnail img-responsive" alt=""></a></li>
                                                    <li><a href="${pageContext.request.contextPath}\resources\images\photos\media2.png" data-rel="prettyPhoto"><img src="${pageContext.request.contextPath}\resources\images\photos\media2.png" class="thumbnail img-responsive" alt=""></a></li>
                                                </ul>
                                            </div><!-- media-body -->
                                        </div><!-- media -->
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img class="media-object img-circle" src="${pageContext.request.contextPath}\resources\images\photos\user3.png" alt="">
                                            </a>
                                            <div class="media-body">
                                                ...
                                                <div class="media blog-media">
                                                    <a class="pull-left" href="#">
                                                        <img class="media-object" src="${pageContext.request.contextPath}\resources\images\photos\media3.png" alt="">
                                                    </a>
                                                    <div class="media-body">
                                                        <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Read more</a></p>
                                    ...
                                    <div class="events">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="media">
                                                    <a class="pull-left" href="#">
                                                        <img class="media-object thumbnail" src="holder.${pageContext.request.contextPath}\resources\js\100x120.htm" alt="">
                                                    </a>
                                                    <div class="media-body">
