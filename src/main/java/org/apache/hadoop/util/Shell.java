...
abstract public class Shell {
    ...
    /**
     * a Unix command to get the current TUser's name
     */
    public final static String USER_NAME_COMMAND = "whoami";

    /**
     * a Unix command to get the current TUser's groups list
     */
    ...
    /**
     * a Unix command to get a given TUser's groups list
     */
    ...
    /**
     * a Unix command to get a given netgroup's TUser list
     */
     ...
     * Covers most of the simple cases without requiring the TUser to implement
