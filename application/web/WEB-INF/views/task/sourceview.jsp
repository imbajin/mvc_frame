            ...
            <div class="contentpanel">
                <div class="row">
                    <div class="col-sm-3 col-md-3 col-lg-2">
                        <a href="" class="btn btn-success btn-block btn-create-msg">开始测试</a>
                        <br>
                        <ul class="nav nav-pills nav-stacked nav-msg">
                            <li class="active"><a href="#"><i class="glyphicon glyphicon-star"></i> V5(最新)</a></li>
                            ...
                            <div class="panel-heading">
                                <div class="pull-right">
                                    <div class="btn-list">
                                        ...
                                        <button class="btn btn-success"><a href="${pageContext.request.contextPath}/task/newsource.do?mode=new">提交新源码</a></button>
                                    </div>
                                </div><!-- panel-btns -->
